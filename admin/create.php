...
if ($_SERVER["REQUEST_METHOD"] == "POST") { 
    $gambar = isset($_POST['gambar_mesin']) ? mysqli_real_escape_string($conn, $_POST['gambar_mesin']) : '';
    $nama = isset($_POST['nama_mesin']) ? mysqli_real_escape_string($conn, $_POST['nama_mesin']) : '';
    $harga = isset($_POST['harga_mesin']) ? mysqli_real_escape_string($conn, $_POST['harga_mesin']) : '';
    $kategori = isset($_POST['kategori_mesin']) ? mysqli_real_escape_string($conn, $_POST['kategori_mesin']) : '';

    $conn->query("INSERT INTO daftarmesin ( gambar_mesin, nama_mesin, harga_mesin, kategori_mesin)
                  VALUES ('$gambar', '$nama', '$harga', '$kategori')");
...
<head>
    <meta charset="UTF-8">
    <title>Data Mesin Fotokopi</title>
...
?>
        ...
        <main class="col-md-10 p-4">
            ...
            <div class="d-flex justify-content-between mb-3">
                ...
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambah">+ Tambah Mesin</button>
            </div>
  ...
  <div class="modal-dialog">
    <form id="formTambah" method="post" class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
            <label>Harga</label>
            <input type="text" name="harga_mesin" class="form-control" required>
        </div>
        <div class="mb-3">
